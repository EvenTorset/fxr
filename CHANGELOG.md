...
- Improved how action properties are sorted. This should not really affect anything except the documentation site and possibly the order of the properties in the auto-completion menu in some editors.
